...
namespace PushButton_Sample
{
    public class CapsiumApp : App<Linux<RaspberryPi>>
    {
        ...
        void FontScaleTest()
        {
            ...
            _graphics.DrawText(0, 240, "Capsium!", Color.Red, ScaleFactor.X2);
        ...
        void ColorFontTest()
        {
            ...
            _graphics.DrawTriangle(120, 20, 200, 100, 120, 100, Capsium.Foundation.Color.Red, false);

            _graphics.DrawRectangle(140, 30, 40, 90, Capsium.Foundation.Color.Yellow, false);

            _graphics.DrawCircle(160, 80, 40, Capsium.Foundation.Color.Cyan, false);

            int indent = 5;
            int spacing = 14;
            int y = indent;

            _graphics.DrawText(indent, y, "Capsium F7 SPI ST7789!!");

            _graphics.DrawText(indent, y += spacing, "Red", Capsium.Foundation.Color.Red);

            _graphics.DrawText(indent, y += spacing, "Purple", Capsium.Foundation.Color.Purple);

            _graphics.DrawText(indent, y += spacing, "BlueViolet", Capsium.Foundation.Color.BlueViolet);

            _graphics.DrawText(indent, y += spacing, "Blue", Capsium.Foundation.Color.Blue);

            _graphics.DrawText(indent, y += spacing, "Cyan", Capsium.Foundation.Color.Cyan);

            _graphics.DrawText(indent, y += spacing, "LawnGreen", Capsium.Foundation.Color.LawnGreen);

            _graphics.DrawText(indent, y += spacing, "GreenYellow", Capsium.Foundation.Color.GreenYellow);

            _graphics.DrawText(indent, y += spacing, "Yellow", Capsium.Foundation.Color.Yellow);

            _graphics.DrawText(indent, y += spacing, "Orange", Capsium.Foundation.Color.Orange);

            _graphics.DrawText(indent, y += spacing, "Brown", Capsium.Foundation.Color.Brown);
